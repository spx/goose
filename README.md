...
Disclaimer: This is a fork from goose repository where I have removed SQLite support as it was interefering with cross platform compilation using [gox](https://github.com/mitchellh/gox). I have fixed every test except 1, but there is no guarantee of absence of unexpected behavior or bugs, please use this at your own risk.
